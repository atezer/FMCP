...
> User prompt: "SUI ile iOS ödeme sayfası" (device/mode belirsiz)
>
> ❌ YANLIŞ: 4 ayrı soru (Q1 device, Q2 mode, Q3 approach, Q4 ölçek)
> ✅ DOĞRU: Tek Adım 6 özet:
> "Anladım — SUI + iOS payment. Netleştirmem gereken: device (iPhone 17 default), mode (Light default), approach (build-from-scratch + reference override), ölçek (tek scroll). Onaylıyor musun? [✅ Bunlarla başla / ✏️ Değiştir / ❌ İptal]"
...
> "Anladım: SUI + iOS payment + build-from-scratch + reference override.
>
> Netleştirmem gereken:
>  (a) Device: iPhone 17 (default, SUI tablosundan) / 16 Pro / 16 / 13-14
