...
> Paket surumu (`package.json`): **1.6.3**
...
**Kod taramasi ozeti:** `docs/TOOLS.md` / `TOOLS_FULL_LIST.md` / `FMCP_AGENT_CANVAS_COMPAT.md` — `dist/local-plugin-only.js` ile parite (2026-04). Yayin: `npm view @atezer/figma-mcp-bridge version` ile **1.6.3** dogrulanabilir (yayim sonrasi).
...
|-------|--------|
| `.mcp.json` | Mevcut (kok) |
| `.cursor-plugin/plugin.json` | Mevcut; surum **1.6.3**, aciklama `docs/TOOLS.md` referansli |
