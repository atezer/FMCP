...
export function degradedStatusPayload(info) {
    return {
        ...
        reason: info.reason,
        message: "F-MCP Bridge bu ortamda çalışmıyor: Figma plugin'i sizin bilgisayarınızda, bu oturum ise başka bir makinede (bulut/uzak) ya da bağımlılıklar kurulu değil. figma_* araçları burada kullanılamaz.",
        fix: [
...
export function handleDegradedMessage(msg, info) {
    ...
    switch (msg.method) {
        case "initialize": {
            ...
            return reply({
                ...
                instructions: "F-MCP Bridge DEGRADED modda: Figma plugin'ine bu ortamdan ulaşılamıyor. Yalnızca figma_get_status aracı var; onu çağırıp kullanıcıya nedenini ve çözümü ilet. Diğer figma_* araçlarını deneme.",
            });
        }
        case "ping":
            return reply({});
...
export function runDegradedServer(info) {
...
//# sourceMappingURL=degraded-server.js.map