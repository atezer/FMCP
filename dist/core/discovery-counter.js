...
export class DiscoveryCounter {
    ...
    classify(toolName, executeCode) {
        ...
        if (toolName === "figma_instantiate_component" ||
...
//# sourceMappingURL=discovery-counter.js.map