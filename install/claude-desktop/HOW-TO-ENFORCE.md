...
8. **`.claude/design-systems/<ds>/CHEATSHEET.md`** — DS workflow rehberi (varsa, kullanıcı-lokal)
...
3. Design system: [ÖRN: ❖ Ana-DS] — user-local `~/.claude/data/fcm-ds/active.md` veya runtime resolve.
