...
export async function handleCloudModeRoutes(request: Request, env: Env): Promise<Response | null> {
...
export function maybeTightenMcpCors(request: Request, response: Response): Response {
